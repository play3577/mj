...
module.exports = function createWebClient(request, response, forwardURL) {
  ...
  let run = data => {
    ...
    if (data.indexOf(`web client listening on `) > -1) {
      ...
      // Once we've done this, stop "listening" and instead just
      // forward i/o data without any processing.
