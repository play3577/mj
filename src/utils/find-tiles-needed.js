  ...
  })()(
    {
      1: [
        function(require, module, exports) {
           ...
           */
          function findSingleTilewinClaims(
            tiles,
            path,
            pairs,
            sets,
            ...
            if (pairs === 0 && sets === 4) {
              ...
              if (whittled.length === 2) {
                ...
                if (t2 === t1 + 1) {
                  ...
                  let tn = t2 + 1;
                  if (suit(tp) === suit(t2))
                    claimable.push(claim(tp, "win", "chow1"));
                  if (suit(tn) === suit(t1))
                    claimable.push(claim(tn, "win", "chow3"));
                }
      ...
      2: [
        ...
        { "../../../utils/suit.js": 6, "./graph/graph-node": 5 }
      ],
      3: [
        function(require, module, exports) {
      ...
      5: [
        function(require, module, exports) {
          ...
          class Node {
            ...
            addIncoming(link) {
              let found = this.inbound.find(link =>
                this.tiles.equals(link.tiles)
              );
            ...
            getNode(tiles) {
              ...
              this.nodelist[depth] = this.nodelist[depth] || [];
              let node = this.nodelist[depth].find(node =>
                tiles.equals(node.tiles)
              );
    ...
    ${this.outbound.join(`\n    `)}
          ...
          Node.toString = function toString(node) {
            return Object.keys(node.nodelist)
              .sort((a, b) => (a | 0) - (b | 0))
              .map(depth =>
                node.nodelist[depth].map(n => n.toString()).join("\n")
              )
              .join("\n");
          };
