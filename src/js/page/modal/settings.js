class SettingsModal {
  ...
  show() {
    ...
    const values = {
      ...
      bot_clean_threshold: BOT_CLEAN_THRESHOLD.toString(),
      bot_limit_threshold: BOT_LIMIT_THRESHOLD.toString(),
    ...
    const options = {
      ...
      'Bot clean play threshold': { key: 'bot_clean_threshold' },
      'Bot limit hand threshold': { key: 'bot_limit_threshold' },
